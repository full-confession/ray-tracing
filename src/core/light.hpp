...
namespace fc
{
    ...
    public:
        ...
        virtual std::optional<standard_light_sample_p_and_wo_result> sample_p_and_wo(vector2 const& sample_point, vector2 const& sample_direction, allocator_wrapper& allocator) const = 0;
