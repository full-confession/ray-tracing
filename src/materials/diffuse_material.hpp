...
namespace fc
{
    ...
    public:
        ...
        {
            bxdf const* bxdf{allocator.emplace<bxdf_adapter<lambertian_reflection>>(
                lambertian_reflection{reflectance_->evaluate(p.get_uv())}
            )};
    ...
    class diffuse_material2 : public material
    {
    public:
        explicit diffuse_material2(std::shared_ptr<texture_2d_rgb> reflectance, std::shared_ptr<texture_2d_rgb> normal)
